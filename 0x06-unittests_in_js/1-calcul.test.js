...
describe('calculateNumber', () => {
  ...
  describe('type == "DIVIDE"', () => {
    ...
    it('equal rounded down numbers', () => {
      assert.strictEqual(calculateNumber('DIVIDE', 2.41, 2.0), 1);
    });
    ...
    it('positive number and number rounded down to 0', () => {
      assert.strictEqual(calculateNumber('DIVIDE', 5.0, 0.21), 'Error');
    });
    ...
    it('0 and 0', () => {
      assert.strictEqual(calculateNumber('DIVIDE', 0.00, 0.00), 'Error');
    });
  });
});

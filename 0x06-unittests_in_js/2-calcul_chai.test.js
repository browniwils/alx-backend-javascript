...
describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    ...
    it('equal negative numbers (alternate)', () => {
      expect(calculateNumber('SUM', -2.2, -1.8)).to.equal(-4);
    });
    ...
    it('positive and negative numbers', () => {
      expect(calculateNumber('SUM', 2.0, -2.00)).to.equal(0);
    });

    it('0 and 0', () => {
      expect(calculateNumber('SUM', 0.00, 0.00)).to.equal(0);
    });
  });
  ...
  describe('type == "SUBTRACT"', () => {
    ...
    it('equal positive numbers (alternate)', () => {
      expect(calculateNumber('SUBTRACT', 2.2, 1.8)).to.equal(0);
    });
    ...
    it('0 and 0', () => {
      expect(calculateNumber('SUBTRACT', 0.00, 0.00)).to.equal(0);
    });
  });
  ...
  describe('type == "DIVIDE"', () => {
    ...
    it('equal negative numbers', () => {
      expect(calculateNumber('DIVIDE', -4.00, -4.00)).to.equal(1);
    });
    ...
    it('negative number and number rounded up to zero', () => {
      expect(calculateNumber('DIVIDE', -2.0, -0.3)).to.equal('Error');
    });
